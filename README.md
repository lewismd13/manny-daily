...
This is my grimoire-ized collection of daily tasks.
...
running in the background. If you've already built symlinks, your up-to-date script can be run instantly by entering `manny-daily` into the KoLmafia CLI.